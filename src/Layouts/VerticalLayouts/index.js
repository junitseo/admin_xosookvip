            ...
            {(navData || [])?.map((item, key) => {
                return (
                    <React.Fragment key={key}>
                        {/* Main Header */}
                        {item['isHeader'] ?
                            <li className="menu-title"><span data-key="t-menu" style={{color:'white',fontWeight:'600'}}>{props.t(item.label)} </span></li>
                            : (
                                (item.subItems ? (
                                    <li className="nav-item">
                                        ...
                                        >
                                            ...
                                            <span data-key="t-apps" style={{color:'black'}}>{props.t(item.label)}</span>
                                            {item.badgeName ?
                                    ...
                                    <li className="nav-item">
                                        <Link
                                            className="nav-link menu-link"
                                            to={item.link ? item.link : "/#"}>
                                            <i style={{color:'black'}} className={item.icon}></i> <span style={{color:'white',fontWeight:'600'}} >{props.t(item.label)}</span>
                                            {item.badgeName ?
                                                <span className={"badge badge-pill bg-" + item.badgeColor} data-key="t-new">{item.badgeName}</span>
                                                : null}
                                        </Link>
